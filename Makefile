...
tmp/import_geonames: tmp/postgres_create_geonames_table tmp/AF.txt
...
output/AF_village_final_popcounts_geonames.json: tmp/import-polygons tmp/index_geonames bin/append-geonames.py
...
output/AF_village_final_popcounts_geonames_unhcr.json: output/AF_village_final_popcounts_geonames.json tmp/import-afg-ppl bin/append-unhcr-af.py
